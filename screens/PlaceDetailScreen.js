...
const PlaceDetailScreen = props => {
    ...
    const showMapHandler = () => {
        props.navigation.navigate('Map', { readonly: true, initialLocation: { lat: selectedPlace.lat, lng: selectedPlace.lng } });
    };
    ...
    return (
        <ScrollView contentContainerStyle={{ alignItems: 'center' }}>
            ...
            <View style={styles.locationContainer}>
                ...
                <MapPreview location={{ lat: selectedPlace.lat, lng: selectedPlace.lng }} style={styles.mapPreview} onPress={showMapHandler} />
            </View>
        </ScrollView>
    );
};
